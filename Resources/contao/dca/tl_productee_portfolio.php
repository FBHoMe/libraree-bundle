...
$moduleName = 'tl_productee_portfolio';
...
$tl_promotee
    ...
    ->addField('pid', 'pid', array(
        'foreignKey' => 'tl_productee_portfolio.id',
        'relation' => array(
            'type'=>'belongsTo',
            'load'=>'eager',
            'table'=>'tl_productee_portfolio',
            'field'=>'id',
        ),
    ))
    ...
    // seitenlink
    #-- Operations
    ->addOperation('edit', 'edit', array('href' => 'table=tl_productee_pin'),'_first')
