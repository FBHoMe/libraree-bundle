...
#-- select pin
$GLOBALS['TL_LANG']['CTE']['libraree'] = array('Bibliothek', 'Libraree');
$GLOBALS['TL_LANG']['CTE']['select_pin'] = array('Pin Auswahl', 'Libraree');
$GLOBALS['TL_LANG'][$moduleName]['select_pin_legend'] = 'Einstellungen';
